...
namespace Varwin.Editor
{
    public class ImportModelsWindow : EditorWindow
    {
        ...
        public static void InitModelImportWindow()
        {
        ...
        public static void InitFolderImportWindow()
        {
        ...
        private void Initialize(string path, bool isFolder)
        {
            ...
            {
                _window.Close();
                EditorUtility.DisplayDialog(SdkTexts.NoModelsToImport, SdkTexts.NoModelsToImport, "Ok");
                return;
            }
        ...
        private void CreateAll()
        {
            ...
            foreach (CreateObjectModel fileModel in _modelsList)
            {
                ...
                {
                    Debug.Log(string.Format(SdkTexts.CannotCreateObjectTypeFormat, fileModel.ObjectName));
                    continue;
                }

                _currentStep = string.Format(SdkTexts.ImportModelStepImportFormat, fileModel.Path);
                ...
                if (Directory.Exists(fileModel.ObjectFolder))
                {
                    EditorUtility.DisplayDialog(
                        string.Format(SdkTexts.ObjectWithNameAlreadyExistsFormat, fileModel.ObjectName),
                ...
                else
                {
                    ...
                    if (extension == null)
                    {
                        ...
                        EditorUtility.DisplayDialog(
                            string.Format(SdkTexts.ModelCannotImportFormat, fileModel.ObjectName),
                            SdkTexts.UnsupportedFileFormat, "OK");
        ...
        private void ImportUsualAsset(CreateObjectModel fileModel)
        {
            try
            {
                Debug.LogFormat(SdkTexts.ImportModelForFormat, fileModel.ObjectName);
            ...
            {
                var message = string.Format(SdkTexts.ImportModelProblemFormat,
        ...
        private void ImportGLTF(CreateObjectModel fileModel)
        {
            ...
            {
                var message = string.Format(SdkTexts.ImportModelProblemStructureFormat,
                    fileModel.ObjectName,
                    fileModel.Path,
                    e.Message);
                EditorUtility.DisplayDialog("Error!", message, "OK");
        ...
        private CreateObjectModel.AssetExtras ParseAssetForLicense(string gltf)
        {
            ...
            {
                throw new GLTFHeaderInvalidException(SdkTexts.GltfCannotBeEmpty);
            }
        ...
        private CreateObjectModel.AssetExtras ParseGLTF(byte[] gltfBinary)
        {
            ...
            {
                Debug.LogError(SdkTexts.GltfAuthoringNotFound);
            }
        ...
        private void Update()
        {
            ...
            {
                var message = string.Format(SdkTexts.CannotImportModelFormat, e.Message);
                EditorUtility.DisplayDialog("Error!", message, "OK");
                Debug.LogException(e);
            }
        }
        ...
        private void CreateCode()
        {
            ...
            {
                CancelCreating();
                Debug.Log(SdkTexts.NoObjectsToCreateCode);
                return;
            }
            ...
            foreach (CreateObjectModel fileModel in _modelsList)
            {
                ...
                _currentStep = string.Format(SdkTexts.CreateCodeStepFormat, fileModel.ObjectName);
            ...
            _currentStep = SdkTexts.CompilingScriptsStep;
            AssetDatabase.Refresh(ImportAssetOptions.ForceUpdate);
        }

        private void CancelCreating()
        {
            EditorUtility.DisplayDialog(SdkTexts.ObjectsCreatingCanceled, SdkTexts.ObjectsCreatingCanceled, "OK");
        ...
        private void CleanUpSketchfabImportFolder()
        {
            ...
            {
                var message = string.Format(SdkTexts.ErrorSketchFabImportMessageFormat, path);
                EditorUtility.DisplayDialog(
                    SdkTexts.ErrorSketchFabImportTitle,
                    message,
                    "OK");
