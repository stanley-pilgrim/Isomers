...
public class SceneCameraEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		if (GUILayout.Button(SdkTexts.MoveCameraToEditorView))
		{
	...
	private void MakeShot()
	{
		...
		Debug.Log(string.Format(SdkTexts.TookScreenShotFormat, fullScreenshotFilePath));
	}
	
	private void CheckScreenshotFolderParameters()
	{
