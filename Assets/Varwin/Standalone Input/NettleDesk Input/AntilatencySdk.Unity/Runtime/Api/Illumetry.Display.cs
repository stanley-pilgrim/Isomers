...
namespace Illumetry.Display {
	...
	public interface ICotask : Antilatency.DeviceNetwork.ICotask {
		...
		Antilatency.PulseWave.PulseWave getFrameSchedule();
	...
	namespace Details {
		public class ICotaskWrapper : Antilatency.DeviceNetwork.Details.ICotaskWrapper, ICotask {
			...
			public void setFrameScheduleReceiver(Antilatency.PulseWave.IPulseWaveReceiver pulseWaveReceiver) {
				...
				HandleExceptionCode(_VMT.setFrameScheduleReceiver(_object, pulseWaveReceiverMarshaler));
			}
			public Antilatency.PulseWave.PulseWave getFrameSchedule() {
				Antilatency.PulseWave.PulseWave result;
				Antilatency.PulseWave.PulseWave resultMarshaler;
				HandleExceptionCode(_VMT.getFrameSchedule(_object, out resultMarshaler));
			...
			public Antilatency.DeviceNetwork.Tasks.Illumetry.Display.PowerState getPowerState() {
				...
				HandleExceptionCode(_VMT.getPowerState(_object, out resultMarshaler));
				result = resultMarshaler;
				return result;
			}
		}
		public class ICotaskRemap : Antilatency.DeviceNetwork.Details.ICotaskRemap {
			public new struct VMT {
				...
				public delegate Antilatency.InterfaceContract.ExceptionCode getFrameScheduleDelegate(System.IntPtr _this, out Antilatency.PulseWave.PulseWave result);
			...
			protected static new void AppendVmt(System.Collections.Generic.List<object> buffer) {
				...
				var vmt = new VMT();
				vmt.setFrameScheduleReceiver = (System.IntPtr _this, System.IntPtr pulseWaveReceiver) => {
					try {
				...
				vmt.getFrameSchedule = (System.IntPtr _this, out Antilatency.PulseWave.PulseWave result) => {
					try {
						var obj = GetContext(_this) as ICotask;
						...
						result = default(Antilatency.PulseWave.PulseWave);
						return handleRemapException(ex, _this);
					}
					return Antilatency.InterfaceContract.ExceptionCode.Ok;
				};
				vmt.getPowerState = (System.IntPtr _this, out Antilatency.DeviceNetwork.Tasks.Illumetry.Display.PowerState result) => {
					try {
						var obj = GetContext(_this) as ICotask;
