...
namespace Antilatency.PulseWave {
	...
	public partial struct PulseWave {
		public ulong start;
...
namespace Antilatency.PulseWave {
	...
	public interface IPulseWaveReceiver : Antilatency.InterfaceContract.IInterface {
		Antilatency.InterfaceContract.Bool setPulseWave(Antilatency.PulseWave.PulseWave pulseWave);
	}
}
...
namespace Antilatency.PulseWave {
	namespace Details {
		public class IPulseWaveReceiverWrapper : Antilatency.InterfaceContract.Details.IInterfaceWrapper, IPulseWaveReceiver {
			...
			public Antilatency.InterfaceContract.Bool setPulseWave(Antilatency.PulseWave.PulseWave pulseWave) {
				Antilatency.InterfaceContract.Bool result;
				Antilatency.InterfaceContract.Bool resultMarshaler;
				HandleExceptionCode(_VMT.setPulseWave(_object, pulseWave, out resultMarshaler));
		...
		public class IPulseWaveReceiverRemap : Antilatency.InterfaceContract.Details.IInterfaceRemap {
			public new struct VMT {
				public delegate Antilatency.InterfaceContract.ExceptionCode setPulseWaveDelegate(System.IntPtr _this, Antilatency.PulseWave.PulseWave pulseWave, out Antilatency.InterfaceContract.Bool result);
			...
			protected static new void AppendVmt(System.Collections.Generic.List<object> buffer) {
				...
				var vmt = new VMT();
				vmt.setPulseWave = (System.IntPtr _this, Antilatency.PulseWave.PulseWave pulseWave, out Antilatency.InterfaceContract.Bool result) => {
					try {
