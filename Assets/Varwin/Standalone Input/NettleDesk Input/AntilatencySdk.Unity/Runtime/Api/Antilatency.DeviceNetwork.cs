...
namespace Antilatency.DeviceNetwork {
	...
	[Antilatency.InterfaceContract.InterfaceId("81ea9312-f66e-4708-acd1-d40a3e6ef9aa")]
...
public static partial class QueryInterfaceExtensions {
	public static readonly System.Guid Antilatency_DeviceNetwork_IPropertyCotask_InterfaceID = new System.Guid("81ea9312-f66e-4708-acd1-d40a3e6ef9aa");
...
namespace Antilatency.DeviceNetwork {
	[Guid("842eff64-3d73-43c1-a079-b3cf0cee39f1")]
	[Antilatency.InterfaceContract.InterfaceId("842eff64-3d73-43c1-a079-b3cf0cee39f1")]
...
public static partial class QueryInterfaceExtensions {
	public static readonly System.Guid Antilatency_DeviceNetwork_INetwork_InterfaceID = new System.Guid("842eff64-3d73-43c1-a079-b3cf0cee39f1");
	...
	namespace Details {
		public class INetworkWrapper : Antilatency.InterfaceContract.Details.IInterfaceWrapper, INetwork {
			...
			public ulong getCurrentTime() {
				...
				HandleExceptionCode(_VMT.getCurrentTime(_object, out resultMarshaler));
				result = resultMarshaler;
				return result;
			}
			...
			public float nodeGetCurrentOutofsyncTime(Antilatency.DeviceNetwork.NodeHandle node) {
				...
				HandleExceptionCode(_VMT.nodeGetCurrentOutofsyncTime(_object, node, out resultMarshaler));
				result = resultMarshaler;
				return result;
			}
		...
		public class INetworkRemap : Antilatency.InterfaceContract.Details.IInterfaceRemap {
			...
			protected static new void AppendVmt(System.Collections.Generic.List<object> buffer) {
				...
				vmt.getCurrentTime = (System.IntPtr _this, out ulong result) => {
					try {
						var obj = GetContext(_this) as INetwork;
				...
				vmt.nodeGetCurrentOutofsyncTime = (System.IntPtr _this, Antilatency.DeviceNetwork.NodeHandle node, out float result) => {
					try {
						var obj = GetContext(_this) as INetwork;
