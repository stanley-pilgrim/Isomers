...
Shader "Varwin/Mobile/Standard (4P)"
{
    Properties 
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f_surf vert_surf (appdata_full v)
            {
                ...
                fixed3 light = fixed3(0.0, 0.0, 0.0);
                ...
                {  
                    ...
                    fixed3 diffuseReflection = attenuation 
                    * unity_LightColor[index].rgb 
                    * max(0.0, dot(o.normalWorld, lightDirection));     
            
                    light = light + diffuseReflection;
                }
                o.light = light;
            ...
            fixed4 frag_surf (v2f_surf IN) : SV_Target
            {
                ...
                {  
                    ...
                    fixed3 fragmentToLightSource = 
                    lightPosition.xyz - IN.posWorld.xyz;    
                    fixed3 lightDirection = normalize(fragmentToLightSource);
                    fixed squaredDistance = 
                    dot(fragmentToLightSource, fragmentToLightSource);
                    fixed attenuation = 1.0 / (1.0 + 
                    unity_4LightAtten0[index] * squaredDistance);
                    fixed3 diffuseReflect = attenuation 
                    * unity_LightColor[index].rgb 
                    * max(0.0, dot(surfaceNormal, lightDirection));     

                    light = light + diffuseReflect;
                }
                light += IN.light;
                ...
                fixed3 diffuseLight = (diffuseReflection(surfaceNormal) * occlusion)+light;
                ...
                fixed4 cubemap = fixed4(DecodeHDR(skyData, unity_SpecCube0_HDR), 1.0) * occlusion;
