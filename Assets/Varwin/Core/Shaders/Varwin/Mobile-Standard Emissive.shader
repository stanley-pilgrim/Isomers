...
Shader "Varwin/Mobile/Standard (Emissive)"
{
    Properties 
    {
        ...
        [HDR]_EmissionColor("Emissive", Color) = (1, 1, 1, 0)
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma only_renderers gles3 d3d11 vulkan// OpenGL ES 3.0 d3d11 for Editor. glcore gles metal vulkan d3d11_9x
            ...
            fixed4 frag_surf (v2f_surf IN) : SV_Target
            {
                ...
                fixed4 EmissiveMap = tex2D(_EmissionMap, IN.pack0.xy);
                ...
                fixed3 diffuseLight = diffuseReflection(surfaceNormal) * occlusion;
                ...
                fixed3 metalsh = ((albedo)*cubemap)+((specular*10))+(emiss*((_EmissionColor.rgb)*_EmissionColor.a));
