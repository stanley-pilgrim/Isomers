...
namespace Varwin.PlatformAdapter
{
    public abstract class ObjectInteraction
    {
        ...
        {
            public abstract bool isGrabbable { set; get; }
            public abstract bool isUsable { set; get;}
            public abstract bool isTouchable { set; get; }
            public abstract ValidDropTypes ValidDrop { get; set; }
