...
namespace Varwin.PlatformAdapter
{
    public abstract class ControllerInteraction
    {
        ...
        public abstract class ControllerSelf
        {
            ...
            public abstract void ForceGrabObject(GameObject gameObject);
            public abstract void ForceDropObject();
            public abstract void ForceDropObject(GameObject gameObject);
            public abstract void SetGrabColliders(Collider[] colliders);
        ...
        public const ControllerHand DefaultDesktopIterationHand = ControllerHand.Right;
