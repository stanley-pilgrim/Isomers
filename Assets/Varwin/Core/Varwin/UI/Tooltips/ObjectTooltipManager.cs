...
namespace Varwin.UI
{
    public static class ObjectTooltipManager
    {
        ...
        {
            return SetObjectTooltip(tooltippedObject, tooltipText, objectTooltipSize, verticalOffset, ObjectTooltip.ObjectTooltipDirection.Up);
        }
        
        public static bool SetObjectTooltip(GameObject tooltippedObject, string tooltipText, ObjectTooltipSize objectTooltipSize, float verticalOffset, ObjectTooltip.ObjectTooltipDirection objectTooltipDirection)
        {
            ...
            tooltip.SetTooltip(tooltippedObject, tooltipText, objectTooltipSize, verticalOffset, objectTooltipDirection);
