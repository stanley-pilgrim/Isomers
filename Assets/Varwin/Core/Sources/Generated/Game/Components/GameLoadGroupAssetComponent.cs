...
public partial class GameEntity {
    ...
    public void AddLoadGroupAsset(Varwin.Data.ServerData.SceneObjectDto newValue, int newIdPhoton) {
    ...
    public void ReplaceLoadGroupAsset(Varwin.Data.ServerData.SceneObjectDto newValue, int newIdPhoton) {
        var index = GameComponentsLookup.LoadGroupAsset;
        var component = CreateComponent<Varwin.ECS.Components.Events.LoadGroupAssetComponent>(index);
        component.Value = newValue;
        component.IdPhoton = newIdPhoton;
